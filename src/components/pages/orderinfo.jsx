        ...
        <div className="p-3 text-center bg-white border-bottom">
          <div className="container">
            <div className="d-flex justify-content-between">
              <div className="">
                <Link to="https://mdbootstrap.com/" target="_blank" className="">
                  <img
              ...
              <div className="">
                <Link
                  to="https://github.com/mdbootstrap/bootstrap-material-design"
                  className="me-1 border rounded py-1 px-3 nav-link"
                  target="_blank"
                >
                  {" "}
