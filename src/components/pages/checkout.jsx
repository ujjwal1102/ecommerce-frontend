...
import PaymentModal from "../modals/payment_modal";
...
const Checkout = () => {
  ...
  useEffect(() => {
    getCartPrice(JSON.parse(localStorage.getItem("cart")));
                    ...
                    <div className="col-sm-8 mb-3">
                      ...
                      <div className="form-outline">
                        <input
                          ...
                          placeholder="Type here"
                          className="form-control"
                          defaultValue={Address.customer.address}
                        />
                      </div>
                    </div>
                    <div className="col-sm-4 mb-3">
                      ...
                      <div className="form-outline">
                        <input
                          ...
                          placeholder="Type here"
                          className="form-control"
                          defaultValue={Address.customer.city}
                        />
                      </div>
                    </div>
                    <div className="col-sm-4 mb-3">
                      ...
                      <div className="form-outline">
                        <input
                          ...
                          placeholder="Type here"
                          className="form-control"
                          defaultValue={Address.customer.state}
                        />
                      </div>
                    </div>
                    <div className="col-sm-4 col-6 mb-3">
                      ...
                      <div className="form-outline">
                        <input
                          ...
                          className="form-control"
                          defaultValue={Address.customer.pin_code}
                        />
                      </div>
                    </div>
                    <div className="col-sm-4 col-6 mb-3">
            ...
            <div className="col-xl-4 col-lg-4 d-flex justify-content-center justify-content-lg-end">
              <div className="ms-lg-4 mt-4 mt-lg-0" style={{ maxWidth: 320 }}>
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <p className="mb-2">{loading ? "Loading" : `$${totalPrice}`}</p>
                </div>
                <div className="d-flex justify-content-between">
                ...
                <div className="d-flex justify-content-between">
                  <p className="mb-2">Total price:</p>
                  <p className="mb-2 fw-bold">{loading ? "Loading" : `$${totalPrice}`}</p>
                </div>
                ...
                <div className="my-2">
                  {/* <button className="btn btn-outline-success w-100" onClick={()=>{showModal()}}>Proceed to pay</button> */}
                  <PaymentModal/>
                </div>
                <hr />
