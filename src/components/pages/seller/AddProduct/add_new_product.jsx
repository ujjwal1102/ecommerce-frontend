...
// import DynamicFeatureFormField from "./dynamic_feature_form_field";
...
const AddNewProduct = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await client.get("category/categories",{ withCredentials: true });
        if (response.data) {
                      ...
                      <div className="row flex-row overflow-x-auto">
                        ...
                        {images.map((image, index) => (
                          ...
                          style={{position:"relative"}}
                            key={index}
                            className="image-preview p-1 col-3"
                          ...
                          >
                            ...
                            <span
                              className="badge rounded-pill badge-notification btn btn-light p-0 border-0 small"
                              style={{ position: "absolute", top:"10px", right:"10px" }}
                              onClick={() => handleImageRemove(index)}
                            >
                              <i className="fa-solid fa-xmark text-danger p-1  rounded-5"></i>
                            </span>
                          </div>
                        ))}
                      </div>
                ...
                <div className="card-body">
                  <div data-repeater-list="group-a">
                    <div data-repeater-item="" id="featuresID">
                      <div className="form-label text-secondary small">
